...
IF [%VERSION%] == [] set /p VERSION=Enter the version of the Unishield agent (x.y.z):
IF [%REVISION%] == [] set /p REVISION=Enter the revision of the Unishield agent:

SET MSI_NAME=unishield-agent-%VERSION%-%REVISION%.msi
